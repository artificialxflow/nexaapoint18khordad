...
export default function PaymentList() {
  const { payments, people } = useCatalog();
  ...
  const exportPdf = () => {
    ...
    const body = rows
      ...
      .join('');
    w.document.write(`
      <html><head><title>Payment List</title></head>
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-black text-gray-900">لیست پرداخت‌ها</h1>
        <p className="text-sm text-gray-500 mt-1">نمایش اسناد پرداخت ثبت‌شده</p>
      </div>
